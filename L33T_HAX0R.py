...
Var1 = Hacker.Pymem.read_longlong(Hacker.getAddressFromName('Windows10Universal.exe+03c8e458'))


while Var1 == 0:
 Var1 = Hacker.Pymem.read_longlong(Hacker.getAddressFromName('Windows10Universal.exe+03c8e458'))
 print("Join a game to HAX R0BL0X 0N BYFR0N UWP MICR0S0FT ST0RE R0BL0X!!!")
